...
const DEFAULT_SCROLLS: ScrollEntry[] = [
  ...
  { id: 'apigee-oauth2', title: 'Apigee OAuth2', active: true, path: 'scrolls/apigee-oauth2/SCROLL.md' },
  { id: 'architecture-adrs', title: 'Architecture ADRs', active: true, path: 'scrolls/architecture-adrs/SCROLL.md' },
  { id: 'devops-cicd', title: 'DevOps / CI-CD', active: true, path: 'scrolls/devops-cicd/SCROLL.md' },

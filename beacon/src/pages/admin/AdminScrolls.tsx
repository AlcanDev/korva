...
const DEFAULT_SCROLLS: ScrollEntry[] = [
  ...
  { id: 'apigee-oauth2', title: 'Apigee OAuth2 (FIF)', active: true, path: 'scrolls/apigee-oauth2/SCROLL.md' },
  { id: 'architecture-adrs', title: 'Architecture ADRs (FIF)', active: true, path: 'scrolls/architecture-adrs/SCROLL.md' },
  { id: 'devops-cicd', title: 'DevOps / CI-CD (FIF)', active: true, path: 'scrolls/devops-cicd/SCROLL.md' },
  ...
  { id: 'security', title: 'Security (FIF)', active: false, path: 'scrolls/security/SCROLL.md' },
  { id: 'frontend-angular', title: 'Frontend (Angular/FIF)', active: false, path: 'scrolls/frontend-angular/SCROLL.md' },

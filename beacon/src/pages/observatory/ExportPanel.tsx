		...
		<div className="p-6 max-w-5xl mx-auto space-y-4">
			<header>
				...
				<p className="text-xs text-[#8b949e] mt-1">
					Render the vault as Obsidian-flavored markdown. Each observation
					becomes a note with YAML frontmatter and{" "}
					<code className="font-mono">[[wikilinks]]</code> to related
					observations. Re-running over the same directory is safe — notes are
					rewritten from the live store state.
				</p>
			</header>
	...
	return (
		<div className="rounded-lg border border-[#2ea04340] bg-[#2ea04310] p-4 space-y-3">
			...
			<p className="text-[11px] text-[#8b949e]">
				Open in Obsidian via <em>File → Open vault</em> and pick the output
				folder.
			</p>
		</div>
	);

...
export function PageHero({
	...
	return (
		<header
			className={`relative overflow-hidden rounded-2xl beacon-glass px-6 py-7 mb-6 ${className}`}
		>
			...
			<div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
				<div className="flex-1 min-w-0">
					...
					<div className="flex items-center gap-3 flex-wrap">
						...
						<h1 className="font-display font-700 text-2xl sm:text-3xl text-ink-100 leading-tight tracking-tight">
							{title}
						</h1>

...
1. **Design system compliance** — correct use of Design UI components and tokens?
...
- Interactive elements: `design-button`, `design-input`, `design-select` — no raw HTML equivalents
- Feedback: `design-alerts`, `design-skeleton`, `design-spinner` for states

...
src/
  ...
  infrastructure/
    adapters/
      ...
      __fixtures__/
        external-api-offers-response.fixture.ts
        external-api-offers-response.empty.fixture.ts
```
...
```typescript
// infrastructure/adapters/__fixtures__/external-api-offers-response.fixture.ts
import { ExternalOffersResponse } from '../schemas/external-api-offers.schema';

export const EXTERNAL_API_OFFERS_FIXTURE: ExternalOffersResponse = {
  offers: [
...
export const EXTERNAL_API_OFFERS_EMPTY_FIXTURE: ExternalOffersResponse = {
  offers: [],
  total: 0,
};
```
...
### 4. Adapter tests: mock HttpService
...
import { EXTERNAL_API_OFFERS_FIXTURE } from './__fixtures__/external-api-offers-response.fixture';
...
describe('LifeInsuranceAdapterCL', () => {
  ...
  beforeEach(() => {
    httpMock = { get: jest.fn(), post: jest.fn() } as unknown as jest.Mocked<HttpService>;
    configMock = { get: jest.fn(), getOrThrow: jest.fn() } as unknown as jest.Mocked<ConfigService>;
    configMock.get.mockReturnValue('https://external-api.cl/api');

    adapter = new LifeInsuranceAdapterCL(httpMock, configMock);
  });

  describe('getOffers', () => {
    it('should call EXTERNAL_API with the correct URL and country header', async () => {
      // Arrange
      httpMock.get.mockResolvedValue({ data: EXTERNAL_API_OFFERS_FIXTURE });
      ...
      expect(httpMock.get).toHaveBeenCalledWith(
        'https://external-api.cl/api/cl/v2/insurances/LIFE-001/offers',

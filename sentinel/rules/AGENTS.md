...
**Trigger:** `import.*axios|import.*HttpService|import.*HttpService` in `*/application/**/*.ts`
...
**Message:** Use the team logger (@internal/libs/logger or LoggerInterceptor) instead of console.log.
